      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="/announcements" className="hover:text-[#D4A017] transition-colors">Public Notices & Announcements</Link></li>
            <li><Link href="/investment" className="hover:text-[#D4A017] transition-colors">Investment Sectors</Link></li>
            <li><Link href="/downloads" className="hover:text-[#D4A017] transition-colors">Official Documents & Reports</Link></li>
          </ul>
        </div>
