        ...
        <main className="lg:col-span-3 space-y-16">
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-2 border-b border-gray-200 pb-2">
              <Scroll className="h-5 w-5 text-[#1E5631]" />
            ...
            <div className="relative border-l-2 border-gray-200 pl-6 space-y-8 ml-2">
              <div className="relative">
                ...
                <div className="bg-white border border-gray-100 p-5 rounded-lg shadow-sm space-y-2">
                  <span className="text-xs font-black bg-[#E8F0EA] text-[#1E5631] px-2.5 py-0.5 rounded-full inline-block">Early 1800s</span>
              ...
              <div className="relative">
                ...
                <div className="bg-white border border-gray-100 p-5 rounded-lg shadow-sm space-y-2">
                  <span className="text-xs font-black bg-[#E8F0EA] text-[#1E5631] px-2.5 py-0.5 rounded-full inline-block">1974 Revolution</span>
          ...
          <section className="space-y-6">
            ...
            {/* Standardized to your signature green styling */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-white border-t-4 border-[#1E5631] p-4 rounded-b shadow-sm space-y-1">
                <div className="font-black text-lg text-[#1E5631]">10%</div>
                <div className="font-bold text-xs text-gray-700">Dega (Highland)</div>
              ...
              <div className="bg-white border-t-4 border-[#1E5631] p-4 rounded-b shadow-sm space-y-1">
                <div className="font-black text-lg text-[#1E5631]">65%</div>
                <div className="font-bold text-xs text-gray-700">Woina Dega (Midland)</div>
              ...
              <div className="bg-white border-t-4 border-[#1E5631] p-4 rounded-b shadow-sm space-y-1">
                <div className="font-black text-lg text-[#1E5631]">25%</div>
                <div className="font-bold text-xs text-gray-700">Kola (Lowland)</div>
            ...
            <div className="bg-white border border-gray-100 p-5 rounded-lg shadow-sm flex flex-col sm:flex-row gap-4 items-center">
              <div className="bg-[#F8F6F1] p-3 rounded-md shrink-0">
                <Trees className="h-6 w-6 text-[#1E5631]" />
              </div>
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-2 border-b border-gray-200 pb-2">
              <Users2 className="h-5 w-5 text-[#1E5631]" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-gray-100 p-6 rounded-lg shadow-sm space-y-4">
                <h3 className="font-bold text-sm text-[#2C2C2C] uppercase tracking-wider border-b border-gray-50 pb-1.5 flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-[#1E5631]"></span> Faith & Urban Proportions
                </h3>
                <p className="text-xs text-gray-600 leading-relaxed">
