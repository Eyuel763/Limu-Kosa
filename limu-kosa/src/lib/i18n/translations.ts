...
export const dynamicFallbackMap: Record<string, { am: string; om: string }> = {
  // About Page Strings
  "Limu Kosa is one of the woredas in Jimma Zone of Oromia Region, Ethiopia. Its identity is tied to the historic Limmu-Ennarea kingdom, highland and midland farming systems, protected montane forests, and coffee-centered livelihoods.": { am: "ሊሙ ኮሳ በጅማ ዞን፣ ኦሮሚያ ክልል፣ ኢትዮጵያ ውስጥ ካሉ ወረዳዎች አንዱ ነው። መታወቂያው ከታሪካዊው የሊሙ-ኤናሪያ መንግስት፣ የተራራ እና ደጋ ግብርና ስርዓቶች፣ የተጠበቁ ደኖች እና በቡና ላይ የተመሰረተ ህይወት ጋር የተያያዘ ነው።", om: "Limu Kossaan aanaa Godina Jimmaa, Oromiyaa, Itoophiyaa keessaa isa tokkodha. Eenyummaan isaa mootummaa seenaa Limmu-Ennaariyaa, sirna qonnaa gaaraa fi baddaa, bosona eegamaa fi jireenya bunaa irratti hundaa'eetti hidhata." },
  "The woreda includes river basins, valleys, hills, forest areas, rural kebeles, and urban centers. Coffee, mixed farming, livestock, forest resources, and community institutions remain central to local development.": { am: "ወረዳው የወንዝ ተፋሰሶችን፣ ሸለቆዎችን፣ ኮረብታዎችን፣ የደን ቦታዎችን፣ የገጠር ቀበሌዎችን እና የከተማ ማዕከላትን ያካትታል። ቡና፣ የተቀናጀ ግብርና፣ እንስሳት፣ የደን ሀብቶች እና የማህበረሰብ ተቋማት ለሀገር ውስጥ ልማት ዋና ተፈላጊዎች ናቸው።", om: "Aanichis sulula lagaa, gaarreen, bosona, ganda baadiyyaa fi magaalota dabalata. Buna, qonnaa makamaa, beeylada, qabeenya bosonaa fi dhaabbileen hawaasaa misooma naannoof murteessoodha." },
  "Region": { am: "ክልል / ዞን", om: "Naannoo / Godina" },
  "Jimma Zone, Oromia": { am: "ጅማ ዞን፣ ኦሮሚያ", om: "Godina Jimmaa, Oromiyaa" },
  "Administrative center": { am: "አስተዳደር ማዕከል", om: "Mootummaa Giddugala" },
  "Limmu Genet": { am: "ሊሙ ገነት", om: "Limmu Genet" },
  "Area": { am: "የስፋት መጠን", om: "Bal'ina Lafa" },
  "Elevation": { am: "ከፍታ (ከባህር ወለል በላይ)", om: "Ol'aantummaa" },
  "Kebeles": { am: "ቀበሌዎች", om: "Gandaa" },
  "40 rural and 4 urban": { am: "40 የገጠር እና 4 የከተማ", om: "40 Baadiyyaa fi 4 Magaalaa" },
  "History and identity": { am: "ታሪክ እና መታወቂያ", om: "Seenaa fi Eenyummaa" },
  "The name and administration reflect both historical kingdom roots and local geographic identity.": { am: "ስሙ እና አስተዳደሩ ታሪካዊ የመንግስት ስሮች እና የሀገር ውስጥ ጂኦግራፊያዊ መታወቂያን ያንጸባርቃሉ።", om: "Maqaan fi bulchiinsi hidda mootummaa seenaa fi eenyummaa lafa naannoo agarsiisa." },
  "Early 1800s": { am: "በ1800ዎቹ መጀመሪያ", om: "Jalqaba 1800s" },
  "Limmu-Ennarea emerged as an important Gibe Oromo kingdom and trade center.": { am: "ሊሙ-ኤናሪያ ዋና የጊቤ ኦሮሞ መንግስት እና የንግድ ማዕከል ሆኖ ብቅ አለ።", om: "Limmu-Ennaariyaa mootummaa Oromoo Gibe fi giddugala daldalaa ta'ee mul'ate." },
  "Late 1800s": { am: "በ1800ዎቹ መጨረሻ", om: "Dhuma 1800s" },
  "The area was integrated into the Ethiopian imperial administration, with Kossa becoming a key reference point.": { am: "አካባቢው ወደ ኢትዮጵያ ንጉሠ ነገሥት አስተዳደር ተቀላቀለ፤ ኮሳ ዋና ማጣቀሻ ሆነ።", om: "Naannichi bulchiinsa mootummaa Itoophiyaatti makame, Kossaan qabxii ijoo ta'e." },
  "1974 onward": { am: "ከ1974 ጀምሮ", om: "1974 irraa jalqabee" },
  "Land reforms and later federal restructuring shaped modern kebele administration and woreda boundaries.": { am: "የመሬት ማሻሻያዎች እና በኋላ የፌዴራል መዋቅር ዘመናዊ የቀበሌ አስተዳደር እና የወረዳ ወሰኖችን ቀረጹ።", om: "Haaromsa lafaa fi caasaa federaalaa bulchiinsa gandaa ammayyaa fi daangaa aanaa bocan." },
  "Climate and landscape": { am: "አየር ንብረት እና መሬት", om: "Qilleensa fi Lafa" },
  "Limu Kosa includes dega, woina dega, and kola agro-ecological zones. Seasonal rainfall, varied elevation, and forest systems support coffee, cereals, livestock, fruits, sugar cane, honey, and natural resource livelihoods.": { am: "ሊሙ ኮሳ ደጋ፣ ወይና ደጋ እና ቆላ አግሮ-ኢኮሎጂካል ዞኖችን ያካትታል። ወቅታዊ ዝናብ፣ የተለያየ ከፍታ እና የደን ስርዓቶች ቡናን፣ እህልን፣ እንስሳትን፣ ፍራፍሬዎችን፣ ሸንኮራ አገዳን፣ ማርን እና የተፈጥሮ ሀብት ህይወትን ይደግፋሉ።", om: "Limu Kossaan baddaa, baddadaree fi gammoojjii dabalata. Rooba yeroo, ol'aantummaa garaagaraa fi bosonaan buna, midhaan, beeylada, fuduraa, shonkora, damma fi jireenya qabeenya uumamaa deeggara." },
  "Dega": { am: "ደጋ", om: "Baddaa" },
  "Woina Dega": { am: "ወይና ደጋ", om: "Baddadaree" },
  "Kola": { am: "ቆላ", om: "Gammoojjii" },
  "Economy": { am: "ኢኮኖሚ", om: "Dinagdee" },
  "Coffee": { am: "ቡና", om: "Buna" },
  "Forest and shade-grown Arabica coffee is a defining cash crop and investment identity.": { am: "የደን እና ጥላ-ቡና አረቢካ መታወቂያ የሆነ የገንዘብ ሰብል እና የኢንቨስትመንት መታወቂያ ነው።", om: "Buni bosonaa fi baddaa oomisha maallaqaa fi eenyummaa maallaqaa agarsiisudha." },
  "Mixed Farming": { am: "የተቀናጀ ግብርና", om: "Qonnaa Makamaa" },
  "Maize, sorghum, teff, fruit, sugar cane, and livestock support household livelihoods.": { am: "በቆሎ፣ ማሽላ፣ ጤፍ፣ ፍራፍሬ፣ ሸንኮራ አገዳ እና እንስሳት የቤተሰብ ህይወትን ይደግፋሉ።", om: "Boqqolloo, misingaa, xafii, fuduraa, shonkora fi beeyladni jireenya maatii deeggaru." },
  "Forests": { am: "ደኖች", om: "Bosona" },
  "Protected forests support biodiversity, rainfall, honey, grazing, and local livelihoods.": { am: "የተጠበቁ ደኖች ብዝሃ-ሕይወትን፣ ዝናብን፣ ማርን፣ ግጦሽን እና የሀገር ውስጥ ህይወትን ይደግፋሉ።", om: "Bosonni eegaman biodiversity, rooba, damma, dheedhi fi jireenya naannoo deeggaru." },
  "People and society": { am: "ህዝብ እና ህብረተሰብ", om: "Ummata fi Hawaasa" },
  "Oromo is the largest community and Afaan Oromoo is the leading local language. The woreda is also home to Amhara, Kullo, Kafficho, Tigrayan, and other communities, with Muslim and Christian residents contributing to local society.": { am: "ኦሮሞ ትልቁ ማህበረሰብ ሲሆን አፋን ኦሮሞ ዋነኛው የሀገር ውስጥ ቋንቋ ነው። ወረዳው ለአማራ፣ ኩሎ፣ ካፊቾ፣ ትግራይ እና ሌሎች ማህበረሰቦች መኖሪያ ሲሆን ሙስሊም እና ክርስቲያን ነዋሪዎች ለሀገር ውስጥ ህብረተሰብ አስተዋጽኦ ያደርጋሉ።", om: "Oromoon hawaasa isa guddaa fi Afaan Oromoo afaan naannoo isa ijoodha. Aanichi Amhara, Kullo, Kafficho, Tigrayan fi hawaasa biroofis mana yoo ta'u, jiraattotni Musliimaa fi Kiristaanaa hawaasa naannoof gumaacha godhu." },
  "Vision and values": { am: "ራዕይ እና እሴቶች", om: "Mul'ata fi Gatii" },
  "The public portal supports transparent, inclusive, and development-focused administration.": { am: "የህዝብ ፖርታሉ ግልጽ፣ አካታች እና ልማት ተኮር አስተዳደርን ይደግፋል።", om: "Kutaa argannoo ummataa bulchiinsa iftoomina, dabalataa fi guddinaa irratti xiyyeeffate deeggara." },
  "Transparency": { am: "ግልጽነት", om: "Iftoomina" },
  "Public service": { am: "የህዝብ አገልግሎት", om: "Tajaajila Ummataa" },
  "Sustainable development": { am: "ዘላቂ ልማት", om: "Misooma Itti-fufiinsa Qabu" },
  "Community participation": { am: "የማህበረሰብ ተሳትፎ", om: "Hirmaannaa Hawaasaa" },
  "Cultural respect": { am: "ባህላዊ አክብሮት", om: "Kabaja Aadaa" },
  "Environmental stewardship": { am: "የአካባቢ እንክብካቤ", om: "Kunuunsa Naannoo" },
